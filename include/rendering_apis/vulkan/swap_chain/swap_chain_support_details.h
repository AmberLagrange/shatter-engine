#ifndef RENDERING_APIS_VULKAN_SWAP_CHAIN_SWAP_CHAIN_SUPPORT_DETAILS_H
#define RENDERING_APIS_VULKAN_SWAP_CHAIN_SWAP_CHAIN_SUPPORT_DETAILS_H
...
#endif // RENDERING_APIS_VULKAN_SWAP_CHAIN_SWAP_CHAIN_SUPPORT_DETAILS_H
